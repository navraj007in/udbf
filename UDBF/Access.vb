Public Class Access
    ...
    Public Overrides Function Delete(ByVal Query As String) As Integer
        ...
        Dim Reader As New OleDb.OleDbDataAdapter
    ...
    Public Overrides Function SelectDate(ByVal Query As String) As Date
        Dim Result As New DataTable
        Dim conn As New OleDb.OleDbConnection(Me.ConnString)
        Dim Reader As OleDb.OleDbDataAdapter
        Dim com As New OleDb.OleDbCommand
        Try
            conn.Open()
            com.Connection = conn
            com.CommandText = Query
            Reader = New OleDb.OleDbDataAdapter(com)
            Reader.Fill(Result)
    ...
    Public Overloads Overrides Sub writeXML(ByVal Path As String, ByVal Query As String)
        ...
        ' Dim myAdapter1 As New OleDb.OleDbDataAdapter
        ' Dim dt As String
