...
Public Class Odbc
    ...
    Public Overrides Function Delete(Query As String) As Integer
        Dim conn As New odbcconnection
        Dim Reader As New OdbcDataAdapter
        ...
        Try
            ...
            com.Connection = conn
            com.ExecuteNonQuery()
            '   MessageBox.Show("Delete Successful", "Delete Record", MessageBoxButtons.OK)
            Return 0
    ...
    Public Overloads Overrides Function getMaxValue(Table As String, Field As String) As String
        Dim Value As String = ""
        Dim Query As String
    ...
    Public Overloads Overrides Function getMaxValue(Table As String, Field As String, Where As String) As String
        Dim Value As String = ""
        Dim Query As String
    ...
    Public Overrides Function getTopValue(Table As String, Field As String) As String
        Dim Value As String = ""
        Dim Query As String
        Query = "select max(" & Field & ") from " & Table
        Value = SelectInt(Query)
    ...
    Public Overrides Function SelectDate(ByVal Query As String) As Date
        Dim Result As New DataTable
        Dim conn As New odbcconnection(Me.ConnString)
        Dim Reader As OdbcDataAdapter
        Dim com As New OdbcCommand
        Try
            conn.Open()
            com.Connection = conn
            com.CommandText = Query
            Reader = New OdbcDataAdapter(com)
            Reader.Fill(Result)
    ...
    Public Overloads Overrides Function Update(ByVal Query As String) As Integer
        ...
        Try
            ...
            com.Connection = conn
            com.ExecuteNonQuery()
            '   MessageBox.Show("Updation Successful", "Update Record", MessageBoxButtons.OK)
            Return 0
        Catch ex As Exception
            Log(vbCrLf & "Error :" & ex.StackTrace & vbCrLf & "Details :" & ex.Message & vbCrLf & "Query String :" & Query)
            conn.Close()
